...
class AppConstants {
  static const String APP_NAME = 'Lets Ride Delivery';
  static const double APP_VERSION = 5.6;

  static const String BASE_URL = 'http://admin.letsride.today';
  ...
  static const String Link="$BASE_URL/privacy-policy";

  static const String documentCreateUrl =
      "$BASE_URL/api/v1/delivery-man/document/create";

  static const String allDocumentUrl =
      "$BASE_URL/api/v1/delivery-man/document/alldocuments";

        static const String deleteDocumentUrl =
      "$BASE_URL/api/v1/delivery-man/document/delete";

  static const String sendSupportMessagesUrl="$BASE_URL/api/v1/message/send-support";

  static const String getSupportMessagesUrl="$BASE_URL/api/v1/message/support-messages?UserId=";

  static const String GetMessagesUrl="$BASE_URL/api/v1/message/get";
  static const String sendMessageurl="$BASE_URL/api/v1/message/send";
  static const String docUrl="$BASE_URL/vendor-panel/edit-delivery-doc/";
