    ...
    return Dialog(
      ...
      child: Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          link==null?SizedBox()
          :TextButton(
            child: Text("Privacy Policy", style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_DEFAULT), textAlign: TextAlign.center),
            onPressed: ()async{
             if (!await launchUrl(Uri.parse(AppConstants.Link))) throw 'Could not launch ${Uri.parse(AppConstants.Link)}';
          },),
