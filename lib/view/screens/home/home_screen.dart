  ...
  Future<void> showCustomTrackingDialog(BuildContext context) async =>
      await showDialog<void>(
        ...
        builder: (context) => AlertDialog(
          ...
          content: const Text(
            'Lets Ride  Delivery collects location data to enable location fetching at the time of your online status, even when the app is closed or not in use',
          ),
          actions: [
            TextButton(
            ...
            return Column(children: [
              ...
              GetBuilder<OrderController>(builder: (orderController) {
                ...
                return Column(children: [
                  ...
                  //===================================================================================================
                  //Document section
                  authController.profileModel.document.status==0?
                  InkWell(
                    onTap:()async{
                ...
                child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Row(
                    ...
                    children: [
                    Image.asset(Images.star,scale: 38,),
                    SizedBox(width: 2,),
                    Text(
                      authController.profileModel.document.message.toString(),
                      style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_DEFAULT, color: Colors.white),
