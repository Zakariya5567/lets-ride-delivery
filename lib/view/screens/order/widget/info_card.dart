...
import 'package:efood_multivendor_driver/view/screens/chat/chat_page.dart';
...
class InfoCard extends StatelessWidget {
  ...
  final int orderId;
  InfoCard({@required this.orderId,@required this.title, @required this.image, @required this.name, @required this.addressModel, @required this.phone,
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
       ...
       //chat button
         ...
         TextButton.icon(
                onPressed: () async {
                  chatController.setPage("chat");
                  chatController.setOrderId(orderId);
                  chatController.setChatHeader(name, image);
                ...
                icon: ImageIcon(AssetImage(Images.chat),color: Theme.of(context).primaryColor, size: 20),
                label: Text(
                  'chat'.tr,
                  style: robotoRegular.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL, color: Theme.of(context).primaryColor),
                ),
