...
import 'package:efood_multivendor_driver/controller/documents_controller.dart';
...
import 'package:efood_multivendor_driver/view/screens/document/documents.dart';
          ...
          mainWidget: SingleChildScrollView(
            ...
            child: Column(children: [
              ...
              SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                ...
                // Document
                ProfileButton(icon: Icons.list_alt_sharp,title: 'Document'.tr, onTap: () async{

              //  Get.toNamed(RouteHelper. getDocumnetRoute());


                  SharedPreferences sharedPreferences=await SharedPreferences.getInstance();
                  int userId= sharedPreferences.getInt("user_id");
                  String url="${AppConstants.docUrl}$userId";
                  print("Documnet url is =====>>>>> ${url}");
              ...
              // Support
              ProfileButton(icon: Icons.support_agent,title: 'Support'.tr, onTap: () async{

               print("image is : ${ authController.profileModel.image}");
                SharedPreferences sharedPreferences=await SharedPreferences.getInstance();
                int userId= sharedPreferences.getInt("user_id");
                String url="${AppConstants.docUrl}$userId";
                print("Documnet url is =====>>>>> ${url}");
               String image= '${Get.find<SplashController>().configModel.baseUrls.deliveryManImageUrl}/${authController.profileModel != null ? authController.profileModel.image : ''}';
               print("image url: $image");
                chatController.setUserId(userId);
                chatController.setPage("support");
                chatController.setChatHeader(authController.profileModel.fName,image);
