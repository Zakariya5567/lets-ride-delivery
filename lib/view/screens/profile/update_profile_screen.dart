...
class _UpdateProfileScreenState extends State<UpdateProfileScreen> {
    ...
    return Scaffold(
      ...
      body: GetBuilder<AuthController>(builder: (authController) {
        if(authController.profileModel != null && _firstNameController.text.isEmpty) {
          _fullNameController.text = "${authController.profileModel.fName} ${authController.profileModel.lName}"?? '';
                ...
                SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                  ...
                  onChanged: (value){
                    if(value!=null){
                     ...
                     _firstNameController.text=newvalue[0];
                     if(newvalue.length>1 ){
                     newvalue[1]!=''?
                     _lastNameController.text=newvalue[1]:_lastNameController.text='.';
                     }
                     else{
  ...
  void _updateProfile(AuthController authController) async {
    ...
    // }
      ...
      showCustomSnackBar('enter_your_full_name'.tr); }
